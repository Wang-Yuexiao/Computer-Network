...
*/
    private void processRequest() throws Exception {
    	...
    	InputStream is = socket.getInputStream();/*Fill in the Blank*/ //Mission 2: Get input stream from the socket
    	DataOutputStream os = new DataOutputStream(socket.getOutputStream());/*Fill in the Blank*/ //Mission 2: Get Output stream from the socket
	
    	// Set up input stream filters.
    	BufferedReader br = new BufferedReader(new InputStreamReader(is));/*Fill in the Blank*/ //Mission 2: wrap InputStreamReader and BufferedReader filters around the input stream 

        // Mission 2(2-A, 2-B, 2-C): parse the HTTP request (Fill #8 ~ #9)
        String requestLine = br.readLine();/*Fill in the Blank*/ // Mission 2: Get the request line of the HTTP request message
        ...
        String method = tokens.nextToken();/*Fill in the Blank*/ // Mission 2-A: Get method information, Optional Exercises
        String fileName = tokens.nextToken();/*Fill in the Blank*/ // Mission 2-B: Get URI information 
        String version = tokens.nextToken();/*Fill in the Blank*/ // Mission 2-C: Get HTTP Version information
 ...
 */
	    ...
	    statusLine = "HTTP/1.1 200 OK" + CRLF;/*Fill in the Blank*/// Mission 3-A: Status Code 200 OK
        ...
        //#Fill#11. When requested file doesn’t exist, Status Code 404 NOT FOUND
        	statusLine = "HTTP/1.1 404 Not Found" + CRLF;/*Fill in the Blank*/// Mission 3-B: Status Code 404 Not found
        ...
        if (fileExists) {
        	...
        	os.writeBytes(entityBody/*Fill in the Blank*/) ; // Mission 3: Send appropriate entity body
        }
