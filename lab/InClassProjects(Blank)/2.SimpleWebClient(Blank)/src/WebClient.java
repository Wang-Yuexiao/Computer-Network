...
public class WebClient {
    public static void main(String[] args) {
        ...
        try (
        		...
        		Socket socket = new Socket(host, port);/*Fill in the Blank*/
        		//Fill #2, create PrintWirter instance with socket’s OutputStream
        		PrintWriter out = new PrintWriter(socket.getOutputStream(), true);/*Fill in the Blank*/
...
*/
            ...
            out.println("User-Agent: SimpleWebClient");
            out.println();

            // Mission 3: Read and display the response
            //Fill#5,  Read and display the response
            String responseLine;
            while ((responseLine = in.readLine()) != null/*Fill in the Blank*/) {
                /*Fill in the Blank*/
